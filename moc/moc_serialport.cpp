...
QT_MOC_LITERAL(1, 11, 13), // "signalReceied"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12), // "lineReceived"
QT_MOC_LITERAL(4, 39, 12) // "slotReceived"

    },
    "SerialPort\0signalReceied\0\0lineReceived\0"
    "slotReceived"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->lineReceived((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialPort::signalReceied)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SerialPort::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialPort::lineReceived)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SerialPort::lineReceived(QByteArray _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
